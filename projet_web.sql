...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 14 juil. 2019 à 10:09
...
(1, 'product1', 'adidas Yeezy Boost 350 ', 'The Yeezy Beluga 2.0 takes Kanye West\'s famous adidas sneakers full circle by returning to the colors of the first adidas Yeezy Boost 350 V2. The Adidas Yeezy 750 Boot was also part of this collection and it was released in four different colorways.', 'sports_shoes.jpg', 30, '99.99'),
(2, 'product2', 'Casquette NY', 'La celebre equipe de New York, les yankees ou yanks sont surnommes \"les bombardiers du bronx\". Les New York Yankees sont les plus primes de la ligue majeure de baseball avec 27 titres. Leur logo NY est devenu mythique. En vente exclusive chez nous !', 'cap.jpg', 0, '24.99'),
...
(5, 'product5', 'Nike Claquettes', 'You can show off during the summer with these Nike Benassi tap dance for men. With a unique synthetic lined strap for greater comfort and easy donning. The midsole is made of Phylon for more cushioning, while keeping its lightness.', 'claquette.jpg', 20, '25.00'),
